        ...
        {showSignInSheet && (
          <>
            ...
            >
              ...
              <p className="text-stone-500 text-xs text-center max-w-[280px] mb-8 font-medium">
                We use Google to verify your identity. We never post on your behalf or share your private data.
              </p>

              <button
                onClick={signIn}
                className="w-full py-4 bg-stone-900 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl hover:bg-black transition-all transform active:scale-[0.98] flex items-center justify-center gap-3"
              >
